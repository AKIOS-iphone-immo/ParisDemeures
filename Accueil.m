...
- (void)viewDidLoad {
	...
	[boutonRecherche setFrame:CGRectMake(20, 120, 280, 46)];
	[boutonCarte setFrame:CGRectMake(20, 60, 280, 46)];
    ...
    [notreSelection  setFrame:CGRectMake(0, 190, 320, 20)];
    notreSelection.text = @"Nos biens récents";
    notreSelection.textAlignment = UITextAlignmentCenter;
    notreSelection.font = [UIFont fontWithName:@"Arial-BoldMT" size:22];
...
- (void)requestDone:(ASIHTTPRequest *)request
{
    ...
    if ([string length] > 0) {
        ...
        if ([string rangeOfString:@"<biens></biens>"].length != 0) {
            ...
            [myOpenFlowView setFrame:CGRectMake(10, 220, 300, 130)];
