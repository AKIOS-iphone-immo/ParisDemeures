...
- (void)viewDidLoad
{
    ...
    //TEXTE
    UITextView *descriptif = [[UITextView alloc] initWithFrame:CGRectMake(0, 231, 320, 70)];
    ...
    [contact setFrame:CGRectMake(0,302,320,20)];
    [self.view addSubview:contact];
    [contact release];
    
    //TEL
    UITextView *tel = [[UITextView alloc] initWithFrame:CGRectMake(15, 325, 150, 20)];
    ...
    //FAX
    UITextView *fax = [[UITextView alloc] initWithFrame:CGRectMake(180, 325, 150, 20)];
