...
- (void)viewDidLoad
{
	...
	[boutonPrix setFrame:CGRectMake(40, 75, 120, 50)];
	...
	[boutonSurface setFrame:CGRectMake(162, 75, 120, 50)];
    ...
    [vierge setFrame:CGRectMake(0,130,320,20)];
    [self.view addSubview:vierge];
    [vierge release];
    
    //NOMBRE D'ANNONCES DANS BANDEAU
    UITextView *nbAnnoncesText = [[UITextView alloc] initWithFrame:CGRectMake(0, 130, 320, 20)];
    ...
    [tableView1 setFrame:CGRectMake(0, 150, 320, 270)];
