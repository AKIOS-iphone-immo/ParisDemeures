...
@implementation ParisDemeuresAppDelegate
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"ParisDemeures.sqlite"];
