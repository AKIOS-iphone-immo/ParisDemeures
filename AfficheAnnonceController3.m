...
- (void)viewDidLoad
{
    ...
    [description setFrame:CGRectMake(0,210,320,20)];
    [self.view addSubview:description];
    [description release];
    
    //TEXTE
    UITextView *descriptif = [[UITextView alloc] initWithFrame:CGRectMake(0, 231, 320, 100)];
    ...
    [contact setFrame:CGRectMake(0,332,320,20)];
    [self.view addSubview:contact];
    [contact release];
    
    //TEL
    UITextView *tel = [[UITextView alloc] initWithFrame:CGRectMake(15, 355, 150, 20)];
    ...
    //FAX
    UITextView *fax = [[UITextView alloc] initWithFrame:CGRectMake(180, 355, 150, 20)];
    ...
    [ecrivez setFrame:CGRectMake(5, 380, 95, 65)];
    ...
    [appelez setFrame:CGRectMake(110, 380, 95, 65)];
    ...
    [envoyez setFrame:CGRectMake(215, 380, 95, 65)];
