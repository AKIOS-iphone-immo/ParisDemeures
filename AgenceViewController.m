...
- (void)viewDidLoad
{
	...
	[boutonHistorique setFrame:CGRectMake(x1, y1, w, 45)];
	...
	[boutonEngagements setFrame:CGRectMake(x2, y1, w, 45)];
	...
	[boutonCollaborateurs setFrame:CGRectMake(x1, y2, w, 45)];
	...
	[boutonPrestations setFrame:CGRectMake(x2, y2, w, 45)];
